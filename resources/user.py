...
arguments.add_argument("name", type=str, required=True, help="Nome é obrigatório")
arguments.add_argument("email", type=str, required=True, help="email é obrigatório")
arguments.add_argument("password", type=str, required=True, help="password é obrigatório")
